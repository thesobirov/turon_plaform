let change = document.querySelector('.change_all'), ellipsis = document.querySelector('.ellipsis'),
    ...
    edit_password_btn = document.querySelector('.edit_password_btn');
...
let post_password = document.querySelector('.post_password'),
    edit_username_btn = document.querySelector('.edit_username_btn'),
    post_username = document.querySelector('.post_username');
edit_password_btn.addEventListener("click", () => {
    fetch('/edit_user_password', {
        method: "POST", body: JSON.stringify({
            "info": post_password.value
        }), headers: {
...
edit_username_btn.addEventListener("click", () => {
    fetch('/edit_username', {
        method: "POST", body: JSON.stringify({
            "info": post_username.value
        }), headers: {
            'Content-type': 'application/json'
        }
    })
